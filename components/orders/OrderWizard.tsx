  ...
  return (
    <div>
      <button
        ...
        className="bg-[#1742B1] text-white px-6 py-2.5 rounded-md font-semibold text-sm uppercase tracking-wider hover:bg-[#14399F] hover:shadow-md transition-all duration-200 w-full md:w-auto flex items-center justify-center"
      >
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-center space-x-4">
                <button
                  ...
                  className="w-10 h-10 rounded-md border border-[#DADCE0] bg-white hover:bg-[#F5F7FA] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center"
                >
                  <Minus className="w-4 h-4" />
                </button>
                <div className="text-4xl font-bold w-20 text-center text-[#333333]">
                ...
                <CardContent className="p-4 space-y-4">
                  ...
                  {user && (
                    <>
                      <Separator />
                      <div>
                        <Label className="font-medium">Drop-off Address</Label>
          ...
          <div className="flex justify-between pt-4">
            <button
              ...
              className="px-5 py-2 bg-transparent border border-[#1742B1] text-[#1742B1] rounded-md text-sm font-medium hover:bg-[#F5F7FA] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
            >
            ...
            {currentStep < STEPS.SUMMARY ? (
              <button
                ...
                className="px-5 py-2 bg-[#1742B1] text-white rounded-md text-sm font-medium hover:bg-[#14399F] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
              >
                Next

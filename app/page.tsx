...
export default function Home() {
  ...
  return (
    <LazyMotion features={domAnimation} strict>
      ...
      >
        {/* Navigation - Sharp, aggressive design */}
        ...
        {/* Hero Section - Aggressive color blocking */}
        <section
          ref={heroRef}
          ...
          <div className="relative z-10 w-full">
            <div className="px-6 sm:px-8 md:px-12 py-24 sm:py-32">
              ...
              >
                ...
                {/* Typography - Aggressive Swiss style with new colors */}
                <div className="relative">
                  <m.h1
                    className="text-[14vw] sm:text-[12vw] md:text-[10vw] font-black leading-[0.8] tracking-tighter mb-6 sm:mb-8 text-white"
                ...
                {/* Subtext Grid - Bold blue/orange contrast */}
                <m.div
                ...
                {/* CTA Section - Aggressive orange accent */}
                <m.div
                ...
                >
                  ...
                  >
                    <Input
                      ...
                      className="flex-1 h-14 sm:h-16 bg-white/10 border-2 border-white/20 text-white placeholder:text-white/50 text-base sm:text-lg font-bold focus:border-[#F8B24E] transition-colors"
                      required
                    />
                    <Button
                      type="submit"
                      className="h-14 sm:h-16 px-8 sm:px-12 bg-[#F8B24E] text-[#0F1A7D] hover:bg-[#F5A02C] font-black text-base sm:text-lg shadow-[8px_8px_0px_rgba(255,255,255,0.1)] sm:shadow-[10px_10px_0px_rgba(255,255,255,0.1)] transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_rgba(255,255,255,0.15)]"
                    >
                      CLAIM SPACE
        ...
        <Suspense fallback={<div className="h-96 bg-[#1724B6]" />}>
          <StatsSection />
        </Suspense>

        <Suspense fallback={<div className="h-96 bg-[#0F1A7D]" />}>
          <FeaturesSection />
        </Suspense>
        ...
        {/* NYC Section - Bold color blocking */}
        <section className="py-24 sm:py-32 px-6 sm:px-8 md:px-12 bg-[#1724B6]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              >
                <div className="p-6 sm:p-8 border-2 border-[#F8B24E]/30 bg-[#0F1A7D] hover:bg-[#F8B24E] hover:text-[#0F1A7D] transition-all duration-300 group">
        ...
        {/* Final CTA - Aggressive color contrast */}
        <section className="min-h-[100svh] flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-[#F8B24E] to-[#F5A02C]">
          ...
          <div className="relative z-10 text-center px-6 sm:px-8">
            ...
            >
              ...
              <Button
                type="submit"
                className="w-full h-14 sm:h-16 bg-[#0F1A7D] text-white hover:bg-[#1724B6] font-black text-base sm:text-lg shadow-[0_8px_0px_rgba(15,26,125,0.3)] hover:translate-y-[-2px] hover:shadow-[0_10px_0px_rgba(15,26,125,0.3)] transition-all"
              >
